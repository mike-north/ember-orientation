...
export function initialize(_container, application) {
  ...
  application.register('config:device-orientation-service', orientationServiceDefaults, { instantiate: false });
  application.register('service:device-orientation', DeviceOrientationService);
  application.inject('service:device-orientation', 'orientationServiceDefaults', 'config:device-orientation-service');
